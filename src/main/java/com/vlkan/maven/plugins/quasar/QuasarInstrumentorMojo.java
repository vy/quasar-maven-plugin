...
public class QuasarInstrumentorMojo extends AbstractMojo {
  ...
  private void instrumentClasses(QuasarInstrumentor instrumentor, ClassLoader cl,
      Map<String, File> classes) throws MojoExecutionException {
  ...
  private void instrumentClass(QuasarInstrumentor instrumentor, ClassLoader cl, String name,
